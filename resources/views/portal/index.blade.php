	...
	<div id="slider">
		...
		<div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:4000; transition2d:104; kenburnsscale:1.00;">
			...
			<div class="slider-content ls-l" style="top:60%; left:30%;" data-ls="offsetyin:100%; offsetxout:-50%; durationin:800; delayin:100; durationout:400; parallaxlevel:0;">
				<a class="btn" href="{{url('category/'.$slider->name)}}">{{$slider->name}}</a>
...
<div class="single-post">
	...
	<div class="icons">
		<div class="left-area">
			<a class="btn caegory-btn" href="{{url('category/'.$headline->name)}}"><b>
			{{$headline->name}}</b></a>
		</div>
	</div>
...
<!-- <div class="row">
	...
	<div class="col-lg-6 col-md-6">
		<div class="single-post">
			<div class="image-wrapper"><img src="{{url($posts->thumbnail)}}"></div>
			<div class="icons">
				<div class="left-area">
					<a class="btn caegory-btn" href="{{url('category/'.$posts->id)}}"><b>{{$posts->name}}</b></a>
				</div>
			</div>
